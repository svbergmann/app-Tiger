...
run_base() {
  ...
  mvn --no-transfer-progress -DtgrTestPropCfgCheckMode=myProp -DtgrTestPropCfgEditMode=editProp -DtgrTestPropCfgDeleteMode=deleteProp -P start-tiger-dummy verify | tee mvn-playwright-log.txt &
