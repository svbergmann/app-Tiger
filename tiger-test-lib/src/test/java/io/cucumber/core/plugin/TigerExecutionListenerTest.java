...
/** Verifies the console representation of Tiger's scenario progress. */
class TigerExecutionListenerTest {

  /** Ensures initial, partial, and completed progress are rendered proportionally. */
  @Test
  void shouldFormatProgress() {
